...
if (newGameBtn) newGameBtn.addEventListener("click", SETTINGS.shownbrOfPlayerMenu);
const settingsBtn = document.getElementById("settingsButton");
if (settingsBtn) settingsBtn.addEventListener("click", SETTINGS.showSettingsMenu);
const exitBtn = document.getElementById("exitButton");
if (exitBtn) exitBtn.addEventListener("click", SETTINGS.exitGame);
const onePlayerBtn = document.getElementById("onePlayerButton");
if (onePlayerBtn) onePlayerBtn.addEventListener("click", SETTINGS.startOnePlayerGame);
const twoPlayerBtn = document.getElementById("twoPlayerButton");
if (twoPlayerBtn) twoPlayerBtn.addEventListener("click", SETTINGS.startTwoPlayerGame);
const backBtn = document.getElementById("backButton");
if (backBtn) backBtn.addEventListener("click", SETTINGS.showMainMenu);
