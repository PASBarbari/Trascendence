...
function renderPongInfo() {
	...
	pongInfoContainer.innerHTML = `
		<div class="pong-card">
			...
			<div id="matchHistoryContainer" class="mt-3">
				<h5>Match History</h5>
...
async function matchHistory(page = 1) {
    ...
    try {
        ...
        let pagination = document.getElementById("matchPagination");
        if (pagination) pagination.remove();

        pagination = document.createElement("div");
        pagination.id = "matchPagination";
        ...
        pagination.innerHTML = `
            <button class="btn btn-outline-secondary mx-2" id="prevPageBtn" ${prevDisabled}>
                <i class="fas fa-arrow-left"></i>
            </button>
            <button class="btn btn-outline-secondary mx-2" id="nextPageBtn" ${nextDisabled}>
                <i class="fas fa-arrow-right"></i>
            </button>
        `;

        document.getElementById("matchHistoryContainer").appendChild(pagination);
