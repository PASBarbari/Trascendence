...
export let state = {
	...
	mat: {
		plane: new THREE.MeshPhongMaterial({ color: 0xf0f14e, shininess: 100 }),
		ring: new THREE.MeshPhongMaterial({ color: 0x6ded8a, shininess: 100 }),
		...
		score: new THREE.MeshPhongMaterial({ color: 0xed3833, shininess: 100 }),
	},
	P1cursor: null,
	P2cursor: null,
	isPaused: true,
