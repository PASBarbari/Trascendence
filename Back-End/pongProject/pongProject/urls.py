"""
URL configuration for pongProject project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Pong Game API",
        default_version='v1',
        description="API for Pong game management, multiplayer sessions, and game statistics",
...
<html>
<head>
    <title>Pong Game API Documentation</title>
    <meta charset="utf-8"/>
