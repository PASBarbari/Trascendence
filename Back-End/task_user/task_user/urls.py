"""
URL configuration for task_user project.
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        description="API for user profiles, friendships, and task management",
...
<html>
<head>
    <title>User & Task Management API Documentation</title>
    <meta charset="utf-8"/>
