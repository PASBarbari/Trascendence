...
# Additional 
MINIO_STORAGE_MEDIA_URL = os.getenv('MINIO_MEDIA_URL', f'http://{MINIO_STORAGE_ENDPOINT}/{MINIO_STORAGE_MEDIA_BUCKET_NAME}/')
MINIO_STORAGE_STATIC_URL = os.getenv('MINIO_STATIC_URL', f'http://{MINIO_STORAGE_ENDPOINT}/{MINIO_STORAGE_STATIC_BUCKET_NAME}/')
