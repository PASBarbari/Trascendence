...
from .views import AddUserToGroupView , NewUser , SentNotificationAPIview , NewNotification
...
urlpatterns = [
  path('groups/<int:group_id>/add_user/', AddUserToGroupView.as_view(), name='add_user_to_group'),
	...
	path('notification_history', SentNotificationAPIview.as_view(), name='notification_history'),
