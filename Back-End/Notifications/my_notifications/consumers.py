...
class UserNotificationConsumer(AsyncWebsocketConsumer):
	async def connect(self):
		try:
			...
			print(f"User {self.user.user_id} connected to WebSocket")
	...
	async def send_notification(self, event):
		try:
			...
			print(f"Sent notification: {event['message']}")
		except Exception as e:
	...
	def get_queued_notifications(self):
		try:
			...
			return QueuedNotification.objects.filter(user_id=self.user.user_id, is_sent=False)
		except Exception as e:
